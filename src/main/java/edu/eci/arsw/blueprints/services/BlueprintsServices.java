...
public class BlueprintsServices {
    ...
    public void addNewBlueprint(Blueprint bp) throws BlueprintPersistenceException {
        ...
        try {
            Blueprint bpfiltered = filtreBP(bp);
           bpp.saveBlueprint(bpfiltered);
     ...
     * @return the blueprints filter
     * @throws BlueprintsFiltroException if the filter failed
     */
    public Blueprint filtreBP(Blueprint bp) throws BlueprintsFiltroException {
